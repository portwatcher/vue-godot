...
during device testing to write per-platform remaining check names and descriptions, must-pass and
...
audited progress, exact remaining metadata/must-pass/skippable gap names and check descriptions,
