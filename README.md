...
release-specific reasons. Use `npm run release:record-platform-evidence -- --platform android`
...
audited progress, exact remaining metadata/must-pass/skippable gap names and structured `platformCheckDetails` descriptions,
