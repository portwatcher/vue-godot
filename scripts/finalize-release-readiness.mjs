...
const textReplacements = [
  {
    ...
    after: [
      '- Release/device evidence, CI smoke evidence for the current release candidate,',
      '  and final public wording removal are complete for the production readiness gate.',
    ].join('\n'),
  },
  {
