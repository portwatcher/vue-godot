...
- TODO.md:402 CI passes on a clean commit.
- TODO.md:403 Release preflight passes without warnings in the release environment.
...
- TODO.md:402 CI passes on a clean commit. (ciEvidenceReady waiting)
- TODO.md:403 Release preflight passes without warnings in the release environment. (releaseReadinessEvidenceReady waiting)
- TODO.md:405 All public READMEs match the final support claims. (publicReadmesReady waiting)
- TODO.md:406 The root README warning is removed in the same commit that marks this checklist complete. (rootReadmeWarningReady waiting)
...
Android: ready; iOS: 6 metadata field(s) missing, 15/15 required check(s) unresolved, 14 must-pass check(s) missing
