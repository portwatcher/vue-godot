...
- Configure npm trusted publishing for existing packages with `npx npm@latest trust github <package> --repository portwatcher/vue-godot --file publish.yml --allow-publish --yes`.
