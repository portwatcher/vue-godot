...
warning markers, TODO counts, and structured readiness check status, including
separate Android/iOS real-device evidence status, as JSON for release handoff.
The strict
