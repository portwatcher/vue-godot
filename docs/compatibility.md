...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Vue custom renderer | `runtime-tscn` | `partial` | Godot scene tree nodes | All GodotJS targets | None | Unit, app builds, smoke | Production hardening and stress tests are still pending. |
