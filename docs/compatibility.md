...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `<Div>` | `html` | `partial` | Godot containers and style wrappers | All Godot UI targets | None | Unit, html-demo | CSS flex/grid subset with margin, padding, background, border, and radius wrappers; not a DOM element. |
