...
| production-profile checks | Runs the maintained release API set from the `Release checks` screen or `VUE_GODOT_RELEASE_CHECKS`.  |
...
The iOS simulator smoke record lives in
[`docs/ios-simulator-smoke-2026-07-07.md`](docs/ios-simulator-smoke-2026-07-07.md).
